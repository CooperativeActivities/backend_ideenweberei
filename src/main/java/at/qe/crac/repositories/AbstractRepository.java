 ...
 *
 * @param <T> The domain item this repository manages.
 * @param <ID> The item of the id of the entity this repository manages.
 */
@NoRepositoryBean
public interface AbstractRepository<T, ID extends Serializable> extends Repository<T, ID> {
    ...
    /**
     * Returns all instances of the item.
     *
     * @return All entities.
     */
    List<T> findAll();
     ...
     *
     * @param <S> The actual domain item if the entity.
